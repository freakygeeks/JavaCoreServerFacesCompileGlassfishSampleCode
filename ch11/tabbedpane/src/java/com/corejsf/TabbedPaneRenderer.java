...
public class TabbedPaneRenderer extends Renderer {
   ...
   public void encodeChildren(FacesContext context, UIComponent component)
      ...
      for (SelectItem item : com.corejsf.Renderers.getSelectItems(component))
   ...
   private void encodeTab(FacesContext context, ResponseWriter writer,
      ...
      String clientId = component.getClientId(context);
      String formId = com.corejsf.Renderers.getFormId(context, component);
   ...
   private String getLocalizedTabText(UIComponent tabbedPane, String key) {
      ...
      if (bundle != null) {
         localizedText = com.corejsf.Messages.getString(bundle, key, null);
      }
